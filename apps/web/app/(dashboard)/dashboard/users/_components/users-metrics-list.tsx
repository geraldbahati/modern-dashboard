...
import { CheckCircle2, Eye, UserX, Users, GripHorizontal } from "lucide-react";
import { useState } from "react";

interface UsersMetricsListProps {
  metrics: {
    total: number;
    active: number;
    banned: number;
...
type MetricKey = "verified" | "unverified" | "total" | "banned";
...
export function UsersMetricsList({ metrics }: UsersMetricsListProps) {
