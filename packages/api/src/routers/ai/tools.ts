...
export const createTools = (client: Client) => ({
  ...
  listUsers: tool({
    ...
    inputSchema: listUsersSchema as any,
  ...
  getUserById: tool({
    ...
    inputSchema: getUserByIdSchema as any,
    execute: async (params: any) => {
      try {
  ...
  createUser: tool({
    ...
    inputSchema: createUserSchema as any,
    execute: async (params: any) => {
      try {
  ...
  updateUser: tool({
    ...
    inputSchema: updateUserSchema as any,
    execute: async (params: any) => {
      try {
  ...
  banUser: tool({
    ...
    inputSchema: banUserSchema as any,
    execute: async (params: any) => {
      try {
  ...
  unbanUser: tool({
    ...
    inputSchema: unbanUserSchema as any,
    execute: async (params: any) => {
      try {
  ...
  deleteUser: tool({
    ...
    inputSchema: deleteUserSchema as any,
    execute: async (params: any) => {
      try {
